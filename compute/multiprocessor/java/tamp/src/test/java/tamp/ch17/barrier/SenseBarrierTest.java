 ...
 * @author mph
 */
public class SenseBarrierTest extends TestCase {
  static final int THREADS = 8;   // number threads to test
  static final int ROUNDS = 8;    // how many rounds to test
  
  public SenseBarrierTest(String testName) {
    super(testName);
  }
  
  public static Test suite() {
    TestSuite suite = new TestSuite(SenseBarrierTest.class);
    
    return suite;
  }
  
  /**
   * Test of await method, of class barrier.SenseBarrier.
   */
