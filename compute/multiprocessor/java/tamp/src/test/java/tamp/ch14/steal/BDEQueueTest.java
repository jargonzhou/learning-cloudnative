...
public class BDEQueueTest extends TestCase {
  ...
  public BDEQueueTest(String testName) {
    super(testName);
    instance = new BDEQueue(THREADS);
  ...
  public static Test suite() {
    TestSuite suite = new TestSuite(tamp.ch16.steal.BDEQueueTest.class);
    return suite;
  }
