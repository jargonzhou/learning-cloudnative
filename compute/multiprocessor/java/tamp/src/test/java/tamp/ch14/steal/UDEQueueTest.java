...
public class UDEQueueTest extends TestCase {
  ...
  public UDEQueueTest(String testName) {
    super(testName);
  ...
  public static Test suite() {
    TestSuite suite = new TestSuite(tamp.ch16.steal.UDEQueueTest.class);
    return suite;
  }
