 ...
 */
public class TTASLockTest extends TestCase {
  ...
  TTASLock instance = new TTASLock();
  
  public TTASLockTest(String testName) {
    super(testName);
  }
  
  public static Test suite() {
    TestSuite suite = new TestSuite(TTASLockTest.class);
