...
public class SensorDataServiceVertxProxyHandler extends ProxyHandler {
  ...
  public SensorDataServiceVertxProxyHandler(Vertx vertx, SensorDataService service, long timeoutInSecond){
  ...
  public void handle(Message<JsonObject> msg) {
    try{
      ...
      switch (action) {
        case "sensors": {
          service.sensors(HelperUtils.createListHandler(msg, includeDebugInfo));
          break;
        }
        case "valueFor": {
