package com.spike.nio.channel;

import com.spike.nio.ChannelUtil;
import com.spike.nio.channel.pipe.PipeInJVM;
import com.spike.nio.channel.socket.DatagramChannelClient;
import com.spike.nio.channel.socket.DatagramChannelServer;
...
public class ChannelTest {
    ...
    public void readAndWrite() throws IOException {
        ...
        ChannelUtil.channelCopy1(source, target);
    ...
    private ByteBuffer[] generateByteBuffers(int number) throws Exception {
        ...
        for (int i = 0; i < number; i++) {
            list.add(generateByteBuffer(col1, StringUtils.SPACE));
            list.add(generateByteBuffer(col2, StringUtils.SPACE));
            list.add(generateByteBuffer(col3, System.lineSeparator()));
        }
     ...
     * @see DatagramChannelServer
     * @see DatagramChannelClient
     */
    @Test
