package com.spike.nio2.raf;

import com.spike.Constants;
import com.spike.nio.channel.FileLockTest;
...
public class RandomAccessFileTest {
    ...
    public void positionOfSeekableByteChannel() {
        ...
        bb.put(Constants.NEWLINE.getBytes());
        try (SeekableByteChannel channel =
    ...
    /**
     * @see com.spike.nio.channel.ChannelTest#fileChannelPosition()
     * @see com.spike.nio.channel.ChannelTest##channelTransfer()
     * @see FileLockTest
     */
    @Test
