...
public class DatagramChannelClient {
    public static void main(String[] args) throws Exception {
        DatagramChannelClient client = new DatagramChannelClient(args);
    ...
    public DatagramChannelClient(String[] args) throws Exception {
        if (args.length == 0) {
    ...
    private void printTime(long remote1900, InetSocketAddress isa) {
        ...
        long remote = remote1900 - DatagramChannelServer.DIFF_1900;
