 ...
 * @author zhoujiagen
 */
public class LogAnalysisTask implements Callable<Path> {
    ...
    public LogAnalysisTask(Path path) {
        this.path = path;
    }
    ...
    private void doCall() {
        ...
        try (BufferedReader reader = Files.newBufferedReader(path, cs);
             ...
             BufferedWriter writerAll =
                     Files.newBufferedWriter(Paths.get(GATHER_RESULT_DIR), cs, StandardOpenOption.APPEND,
