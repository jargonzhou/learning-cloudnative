...
public class SocketConstants {
    ...
    public static final InetSocketAddress DEFAULT_ADDRESS = new InetSocketAddress(
            SocketConstants.DEFAULT_HOST, SocketConstants.DEFAULT_PORT);
