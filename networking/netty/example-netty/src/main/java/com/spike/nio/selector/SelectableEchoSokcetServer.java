package com.spike.nio.selector;
...
public class SelectableEchoSokcetServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new SelectableEchoSokcetServer().start(PORT);
    }
        ...
        while (true) {
            ...
            while (iter.hasNext()) {
                ...
                if (key.isReadable()) {
                    ...
                    System.out.println("new incoming data from "
                            + socketChannel.socket().getRemoteSocketAddress() + ":"
                            + socketChannel.socket().getPort());
    ...
    protected void readDataFromSocket(SelectionKey key) throws Exception {
        ...
        while ((count = socketChannel.read(byteBuffer)) > 0) {
            ...
            while (byteBuffer.hasRemaining()) {
                System.out.println("response content: " + NIOUtil.detailsOfBuffer(byteBuffer));
    ...
    private void sayHello(SocketChannel socketChannel) throws Exception {
        ...
        byteBuffer.put(("Hi there!" + System.lineSeparator()).getBytes());
